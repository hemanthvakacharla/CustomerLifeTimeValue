# Below Listed are cover as pat of this solution
# I  customers Segmentation
		1.Find the customers make purchases likely to ads / 
		to purchase?
# II Which type of customers to send ads in order to breakeven and make profit?

# Recency-  how recently did customer purchase?
# Frquency- how often do customer purchase?
# Monetary- Value: how much do they spend (each time on average)?



# Initialize working directory
dir_Input = "C:\Users\Hemanth\Downloads\Data\e-com\data.csv"
